...
At Disco, I am a Software Architect responsible for the DISCO document ingest pipeline. I focus the majority of my time around architecting and developing a serverless pipeline for high-speed parallel document ingest including file typing, conversion, OCR, and translation.}
\end{entrylist}
\begin{entrylist}
\entry
{2017-2019}
