...
At HomeAway, I am leading the effort to unify our front-end ruby-based testing infrastructure to also cover our API, enterprise messaging, big data, and other platforms. My primary focus is on guiding our development teams and architects on how to engineer QA into their projects from the start, by communicating with them on a technical CS level that they can relate with. I also am the lead developer and architect on our several of our Ruby gems used to communicate with and test our backend services. I daily deal with technologies such as RabbitMQ, Elasticsearch, Kibana, Hadoop, Hive, Storm, Kafka, Solr, MSSQL, Spring, git, IntelliJ IDEA, TeamCity, Jira, Confluence, QuickBuild, RRDTool, Splunk, among many others. \\
Detailed achievements:
\begin{itemize}
\item Led and architected the backend quality effort to roll out HomeAway's new owner inbox application based on Elasticsearch
\item Developed HomeAway-specific Ruby libraries to communicate with our internal infrastructure including Elasticsearch, Microsoft SQL Server, Opsview, RabbitMQ, and our core platform APIs
\item Delivered PoC work to integrate the Jolokia JMX library into the HomeAway backend stack
...
\item Led and architected the quality effort for our new platform search service based on Elasticsearch
\item Organized workshops for our engineering group to bring in distinguished speakers in the Computer Science field
\item Led and architected the quality effort to roll out a new caching infrastructure for our high traffic API based on Elasticsearch
\item Continually delivered atomic load test suites to perform load and scale analysis across many of our core platform applications
\item Organized, verified, and led over 75 live production releases of our core platform applications
\item Provided continual platform support to engineers and quality assurance tem members across the organization
\end{itemize}}
\end{entrylist}
\begin{entrylist}
\entry
...
\item Co-author of a clutering algorithm patent 
...
\textbf{PROFESSIONAL:} 
\begin{itemize}
\item \textbf{languages:} Java, JavaScript, C, C++, C\#, Objective-C, Ruby, Python, PHP, Perl, Bash and Korn scripting, HTML, CSS, XML, Docbook,
XSLT, UML, AS400 CL, Rxx, Matlab, Smalltalk (Pharo), Maude, SQL, SQL PL, Elixir, Erlang, BeanShell, Scala, Groovy, Lisp, Fortran, Haskell, \LaTeX
...
Wordpress
\item \textbf{data stores:} MySQL, Oracle (including RAC), IBM DB2, Postgres, SQLite, H2, Derby, CouchDB, Elasticsearch
\item \textbf{big data:} Hadoop, Kafka, Hive, Storm, HBase, Spark, ZooKeeper, Avro, Hunk
\item \textbf{development environments:} Eclipse, Netbeans, JetBrains IntelliJ Idea, Microsoft Visual Studio, Aptana Studio, JetBrains PyCharm, Pharo, Squeak, vim
